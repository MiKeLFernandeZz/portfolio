...
const CardSpotlight = ({children}) => {
  ...
  return (
    <div
      ...
      className='relative flex w-full items-center justify-center overflow-hidden rounded-xl border border-gray-800 bg-gradient-to-r from-black to-gray-950 p-4 md:px-8 md:py-10 shadow-2xl'
    >
      <div
